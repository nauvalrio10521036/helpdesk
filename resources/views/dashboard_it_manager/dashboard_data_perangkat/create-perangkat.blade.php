        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Tambah Perangkat Jaringan</h6>
                    <p class="page-title-description mr-0 d-none d-md-inline-block">Form untuk menambah perangkat jaringan baru</p>
                </div>
                <!-- /.page-title-left -->
                ...
                <div class="col-xl-8 col-lg-10 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                <h5 class="card-title mb-0">
                                    <i class="material-icons">router</i> Form Input Data Perangkat
                                </h5>
                                <a href="{{ route('dashboard_it_manager.view-data-perangkat') }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('dashboard_it_manager.store-perangkat') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-select @error('tipe') is-invalid @enderror" 
                                            ...
                                            <option value="access_point" {{ old('tipe') == 'access_point' ? 'selected' : '' }}>Access Point</option>
                                            <option value="switch_poe" {{ old('tipe') == 'switch_poe' ? 'selected' : '' }}>Switch POE</option>
                                            <option value="mikrotik" {{ old('tipe') == 'mikrotik' ? 'selected' : '' }}>Mikrotik</option>
                                            <option value="switch_hub" {{ old('tipe') == 'switch_hub' ? 'selected' : '' }}>Switch Hub</option>
                                        </select>
                                        @error('tipe')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                                  ...
                                                  name="keterangan" 
                                                  rows="3" 
                                                  placeholder="Catatan tambahan mengenai perangkat...">{{ old('keterangan') }}</textarea>
                                        @error('keterangan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="material-icons">save</i> Simpan Perangkat
                                            </button>
                                        </div>
                                    </div>
                                </div>
