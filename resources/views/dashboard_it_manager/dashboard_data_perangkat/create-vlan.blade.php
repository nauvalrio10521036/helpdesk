        ...
        <main class="main-wrapper clearfix">
            ...
            <div class="row page-title clearfix">
                <div class="page-title-left">
                    <h6 class="page-title-heading mr-0 mr-r-5">Tambah VLAN</h6>
                    <p class="page-title-description mr-0 d-none d-md-inline-block">Form untuk menambah VLAN jaringan baru</p>
                </div>
                <!-- /.page-title-left -->
                <div class="page-title-right d-none d-sm-inline-flex">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard_it_manager.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Tambah VLAN</li>
                    </ol>
                </div>
                <!-- /.page-title-right -->
            </div>
                ...
                <div class="col-xl-8 col-lg-10 mx-auto">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">
                                <i class="material-icons">network_check</i> Form Input Data VLAN
                            </h5>
                        </div>
                        <div class="card-body">
                            <!-- Alert Errors -->
                            ...
                            <form action="{{ route('dashboard_it_manager.store-vlan') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <textarea class="form-control @error('deskripsi') is-invalid @enderror" 
                                                  ...
                                                  name="deskripsi" 
                                                  rows="3" 
                                                  placeholder="Deskripsi atau catatan mengenai VLAN ini...">{{ old('deskripsi') }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="col-12">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button type="submit" class="btn btn-primary">
                                                <i class="material-icons">save</i> Simpan VLAN
                                            </button>
                                        </div>
                                    </div>
                                </div>
